    ...
    <Container title="About - Aaron Soto">
      <div className="flex flex-col justify-center items-start max-w-2xl mx-auto mb-16">
        ...
        <div className="mb-8 prose leading-6 text-gray-600 dark:text-gray-400 ">
          ...
          <div class="max-w-sm w-full lg:max-w-full lg:flex shadow-lg mb-8">
            <div
              class="relative h-48 lg:h-auto lg:w-48 flex-none bg-cover bg-center rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden"
              style={{
            ...
            >
              <div class="absolute top-0 mt-40 right-0 bottom-0 left-0 bg-gradient-to-b from-transparent to-gray-500"></div>
            </div>
            <div class="border-gray-100 lg:border-t lg:border-gray-100 bg-white dark:bg-slate-900 rounded-b lg:rounded-b-none lg:rounded-r px-4 py-2 flex flex-col justify-between leading-normal">
              <div class="mt-5">
          ...
          <div class="max-w-sm w-full lg:max-w-full lg:flex shadow-lg mb-8">
            ...
            <div class="border-gray-100 lg:border-t lg:border-gray-100 bg-white dark:bg-slate-900 rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
              <div class="mt-5">
                <div class="text-gray-900 font-bold text-xl mb-2">
                  React Hangman Game
                </div>
